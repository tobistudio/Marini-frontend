...
export function Cost() {
  ...
  return (
    <>
      ...
      >
        ...
        <div className=" rounded-[34px] bg-white p-6 md:p-12">
          <div className="my-0 flex w-full flex-col sm:flex-row sm:items-center justify-between gap-3 pt-0 pb-5">
            <p className="text-2xl sm:text-3xl font-bold text-black">Cost of Sales</p>
              <Button onClick={() => setCostState(false)} className="flex h-[60px] ml-auto p-2 sm:py-3 sm:px-6 flex-row items-center rounded-2xl bg-[#280559]">
      ...
      >
      <div className="my-5">
        <p className=" text-4xl font-semibold text-[#280559] mb-2">Create Cost Of Sales</p>
        <p className=" font text-base text-[#9898A3]">
        Create or edit Cost Of Sales
        </p>
    ...
    <div className="grid gap-6 mt-4 mb-6 md:grid-cols-2 lg:grid-cols-3">
        <div>
            <label className="block mb-2 text-sm font-semibold text-[#333333]">Cost of Sales Name</label>
            <input type="text" className="placeholder:text-[#BEBFC3] rounded-xl bg-white border-2 border-[#CBD2DC80] p-2.5 text-gray-900 focus:ring-blue-500 focus:border-blue-500 block w-full" placeholder="Cost of Sales Name" required/>
        </div>
        <div>
