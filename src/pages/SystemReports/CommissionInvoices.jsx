    ...
    <div className="mt-[30px] w-full bg-[#E8E9EB] font-display">
      <div>
        <div className=" rounded-[34px] bg-white p-6 md:p-12">
            <p className=" text-3xl font-bold text-[#280559]">Commission Invoice</p>
          <div className="mb-3 mt-12 flex flex-col lg:flex-row justify-center items-center gap-3 rounded-[20px] bg-[#F8F9FB] p-5">
          ...
          <div className="flex flex-col overflow-x-auto">
            <table className="w-full border-none">
              ...
              <tbody className="border-none">
                {Commission_voice_data.map(({ID, Date, Recipient, university, Service, Amount, Status, color}) => (
                  <tr key={ID}>
                  ...
                  <td className="px-6 py-4 text-lg font-semibold text-center text-[#333]">
                    {Amount}
                  </td>
                  <td>
                  <p
