...
export function Home() {
  ...
  return (
    <div className="mt-12 w-full font-display">
      ...
      <div className="mb-12 mr-10 grid grid-cols-1 gap-y-10 gap-x-6 lg:grid-cols-2 2xl:grid-cols-5 w-full">
      ...
      {statisticsCardsData.map((item, id) => 
          item.state === state &&
              <div key = {id} className=" mb-5 mr-10 grid grid-cols-1 gap-y-12 gap-x-6 lg:items-center xl:grid-cols-2 laptop:grid-cols-4">
                {item.charts}
              </div>
        )}
